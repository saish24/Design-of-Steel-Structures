...
public class WeldAngle extends AppCompatActivity {
    ...
    public static final String TAG = "WeldAngle";
...
//        Prompt to fill all values before continuing operation
        ...
        Log.v("UFFFFFFFFFF", "minAreaRequired : " + minAreaRequired);

        Log.v("UFFFFFFFFFF", "strengthOfWeldPerUnitLength : " + strengthOfWeldPerUnitLength);

        Log.v("UFFFFFFFFFF", "lengthOfWeld : " + lengthOfWeld);
